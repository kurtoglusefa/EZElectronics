...
class ProductRoutes {
    ...
    checkGrouping (req: any, res: any, next: any) {

        if (req.query.grouping == 'model' && req.query.category == undefined && req.query.model != undefined) 
        { return next() }
    ...
    initRoutes() {
        ...
        this.router.patch(
            ...
            async (req: any, res: any, next: any) => {
                ...
                try {
                    const totalQuantity = await this.controller.changeProductQuantity(model, quantity, changeDate);
        ...
        this.router.patch(
            ...
            async (req: any, res: any, next: any) => {
                ...
                try {
                    const totalQuantity = await this.controller.sellProduct(model, quantity, sellingDate);
                    res.status(200).json({ totalQuantity });
                } catch(err) {
                    next(err);
                }
        ...
        this.router.get(
            ...
            async (req: any, res: any, next: any) => {
                try {
                    const grouping = req.query.grouping || null;
        ...
        this.router.get(
            ...
            async (req: any, res: any, next: any) => {
                try {
                    ...
                    const category = req.query.category || null;
                    const model = req.query.model || null;
                    const products = await this.controller.getAvailableProducts(grouping, category, model);
                    res.status(200).json(products);
                } catch (err) {
                    next(err);
                }
        ...
        this.router.delete(
            ...
            async (req: any, res: any, next: any) => {
                try {
                    const result = await this.controller.deleteAllProducts()
        ...
        this.router.delete(
            ...
            async (req: any, res: any, next: any) => {
                const { model } = req.params;
                try {
                    const result = await this.controller.deleteProduct(model)
                    res.status(200).json(result)
                } catch(err) {
                    next(err);
                }
